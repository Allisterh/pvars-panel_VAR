...
\dontrun{
data("EURO")
names_i = names(EURO[-1])  # country names
...
R.lags = c(1,2,1,2,2,2,2,2,1,2,2,2,2,1); names(R.lags) = names_i
...
R.boot_EA = sboot.mb(R.id, b.length=8, n.boot=1000, n.cores=6, normf=R.norm)
R.boot_MG = sboot.pmb(R.pid, b.dim=c(8, FALSE), n.boot=1000, n.cores=6, 
                      normf=R.norm, w=EU_w)
R.irf = as.pplot(
